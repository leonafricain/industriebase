    ...
    <v-col cols="8" offset="2">
      ...
      >
                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="6" md="6">
                        <v-text-field v-model="editedItem.doctype" label="type doc"></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="6">
        ...
        <template v-slot:item.actions="{ item }">
          ...
          <v-icon class="red--text text--darken-4" small @click="deleteItem(item)">mdi-delete</v-icon>
        </template>
        <template v-slot:item.pdfname="{ item }">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="far"
...
export default {
  ...
  methods: {
    editItem(item) {
      this.editedIndex = this.pdfs.indexOf(item);
